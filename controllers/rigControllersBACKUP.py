...
def nodeInitializer():
    ...
    ControlBox.aTopA = nAttr.createPoint( 'topFrontRight', 'topFrontRight' )
    nAttr.setDefault( 0.0, 0.0, 0.0 )
    ...
    ControlBox.aTopB = nAttr.createPoint( 'topFrontLeft', 'topFrontLeft' )
    nAttr.setDefault( 0.0, 0.0, 0.0 )
    nAttr.setKeyable( False )
    nAttr.setReadable( True )
    nAttr.setWritable( True )
    ...
    ControlBox.aTopC = nAttr.createPoint( 'topBackRight', 'topBackRight' )
    nAttr.setDefault( 0.0, 0.0, 0.0 )
    nAttr.setKeyable( False )
    nAttr.setReadable( True )
    nAttr.setWritable( True )
    ...
    ControlBox.aTopD = nAttr.createPoint( 'topBackLeft', 'topBackLeft' )
    nAttr.setDefault( 0.0, 0.0, 0.0 )
    nAttr.setKeyable( False )
    nAttr.setReadable( True )
    nAttr.setWritable( True )
    ...
    ControlBox.aBotA = nAttr.createPoint( 'botFrontRight', 'botFrontRight' )
    nAttr.setDefault( 0.0, 0.0, 0.0 )
    nAttr.setKeyable( False )
    nAttr.setReadable( True )
    nAttr.setWritable( True )
    ...
    ControlBox.aBotB = nAttr.createPoint( 'botFrontLeft', 'botFrontLeft' )
    nAttr.setDefault( 0.0, 0.0, 0.0 )
    nAttr.setKeyable( False )
    nAttr.setReadable( True )
    nAttr.setWritable( True )
    ...
    ControlBox.aBotC = nAttr.createPoint( 'botBackRight', 'botBackRight' )
    nAttr.setDefault( 0.0, 0.0, 0.0 )
    nAttr.setKeyable( False )
    nAttr.setReadable( True )
    nAttr.setWritable( True )
    ...
    ControlBox.aBotD = nAttr.createPoint( 'botBackLeft', 'botBackLeft' )
    nAttr.setDefault( 0.0, 0.0, 0.0 )
    nAttr.setKeyable( False )
    nAttr.setReadable( True )
    nAttr.setWritable( True )
